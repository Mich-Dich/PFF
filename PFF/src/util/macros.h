...
// ------------------------------------------- getters -------------------------------------------
#define PFF_DEFAULT_GETTER(type, name)							type get_##name() { return m_##name;}
#define PFF_DEFAULT_GETTER_REF(type, name)						type& get_##name##_ref() { return m_##name;}
#define PFF_DEFAULT_GETTER_C(type, name)						type get_##name() const { return m_##name;}
#define PFF_DEFAULT_GETTER_POINTER(type, name)					type* get_##name##_pointer() { return &m_##name;}
...
#define PFF_GETTER(type, func_name, var_name)					type get_##func_name() { return var_name;}
#define PFF_GETTER_C(type, func_name, var_name)					const type get_##func_name() const { return var_name;}


// ------------------------------------------- setters -------------------------------------------
#define PFF_DEFAULT_SETTER(type, name)							void set_##name(type name) { m_##name = name;}
#define PFF_SETTER(type, func_name, var_name)					void set_##func_name(type value) { var_name = value;}
...
// ------------------------------------------- function for header -------------------------------------------
#define PFF_GETTER_FUNC(type, name)								type get_##name();
#define PFF_GETTER_REF_FUNC(type, name)							type& get_##name##_ref();
#define PFF_GETTER_C_FUNC(type, name)							type get_##name() const;
#define PFF_GETTER_POINTER_FUNC(type, name)						type* get_##name##_pointer();

#define PFF_SETTER_FUNC(type, name)								void set_##name(type name);
...
#define PFF_GETTER_REF_FUNC_IMPL2(type, name, value)			type name = value;															\
																type& get_##name##_ref() { return name; }
// --------- const ---------
...
#define PFF_GETTER_POINTER_FUNC_IMPL2(type, name, value)		type name = value;															\
																type* get_##name##_pointer() { return &name; }
