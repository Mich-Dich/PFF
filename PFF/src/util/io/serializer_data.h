...
#define TEST_NAME_CONVERTION(variable)		PFF::util::extract_vaiable_name(#variable)
#define SERIALIZE_KEY_VALUE(variable)		serialize_key_value(PFF::util::extract_vaiable_name(#variable), variable);
