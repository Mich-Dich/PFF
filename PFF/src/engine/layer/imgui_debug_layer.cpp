...
namespace PFF::UI {
	...
	imgui_debug_layer::imgui_debug_layer() : layer("imgui_debug_layer") { 
	...
	imgui_debug_layer::~imgui_debug_layer() { 
	...
	void imgui_debug_layer::serialize(serializer::option option) {
