...
namespace PFF::UI {
	...
	void update_UI_theme() {
		...
		case PFF::UI::theme_selection::dark:
		{
			...
			colors[ImGuiCol_Tab]					= default_gray;
			colors[ImGuiCol_TabHovered]				= default_gray;
			colors[ImGuiCol_TabActive]				= LERP_MAIN_COLOR_DARK(0.5f);
			colors[ImGuiCol_TabUnfocused]			= default_gray;
			colors[ImGuiCol_TabUnfocusedActive]		= default_gray;
