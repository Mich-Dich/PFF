...
namespace PFF {
	...
	struct PFF_API material {
		...
		void release_resources(VkDevice device);

		material_instance write_material(material_pass pass, const MaterialResources& resources, render::vulkan::descriptor_allocator_growable& descriptor_allocator);
#endif
