...
#define GET_RENDERER				application::get().get_renderer()
	...
	void material::release_resources(VkDevice device) {
	...
	material_instance material::write_material(material_pass pass, const MaterialResources& resources, render::vulkan::descriptor_allocator_growable& descriptor_allocator) {
